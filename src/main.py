...
TO_PREDICT = 'Global CMP22 (vent/cor) [W/m^2]'
...
df = pd.read_csv('./data/data_train/weather_data.csv')
...
joblib.dump(x_scaler, './other/scaler/x_scaler.sav')
joblib.dump(y_scaler, './other/scaler/y_scaler.sav')
...
model.save(f'./model/model-batch_size-{batch_size}-learning_rate-{learning_rate}.h5')